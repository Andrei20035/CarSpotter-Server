...
class AuthCredentialServiceImpl(
    ...
    override suspend fun createCredentials(authCredential: AuthCredential): Int {
        val hashedPassword = BCrypt.withDefaults().hashToString(12, authCredential.password?.toCharArray())
        val authCredentialToSave = authCredential.copy(password = hashedPassword)
        return authCredentialRepository.createCredentials(authCredentialToSave)
    }
